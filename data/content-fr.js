// Arteral Website Content Data - FRANÇAIS
...
export const homePageContent = {
  ...
  lookbook: {
    label: "LOOKBOOK",
    title: "Porté par l'Art",
    quote: "Ces silhouettes attendent leur âme. Chaque glitch est une invitation —",
    quoteHighlight: "donnez vie à cette toile vierge",
    quoteSuffix: ", inscrivez votre art dans le tissu du réel.",
    quoteAuthor: "— EN ATTENTE D'ARTISTES",
    cta: "Découvrir tous les modèles",
  },
  studioGallery: {
    label: "ATELIER CREATIF",
    title: "L'Art Rencontre la Mode",
    subtitle: "Des philosophes aux artistes, chaque reference inspire nos creations",
    cta: "Creer votre oeuvre",
  },
};
...
export const collectionContent = {
  ...
  description: `La série Amour ↔ Ennui explore comment l'amour (expansion du cœur, passion) et l'ennui (repli introspectif, vide) sont deux réactions face à l'intensité de vivre. Ces deux états ne sont pas opposés mais complémentaires - les deux pulsations d'un même cœur.
  ...
  sections: [
    {
      ...
      description: "Chaque collection débute par une exploration philosophique profonde. Pour Amour ↔ Ennui, nous avons étudié les travaux de Jung sur l'intégration des opposés, le concept de Yin/Yang, et la vision nietzschéenne du chaos créateur.",
      subsections: [
        "Histoire du concept Amour/Ennui",
...
export const contactContent = {
  ...
  faq: [
    ...
    {
      question: "Quand sort la collection Amour ↔ Ennui?",
...
export const contestContent = {
  ...
  prizes: [
    ...
    },
    {
      ...
      rewards: [
        "1000€ en cash",
        "Pièce collection Amour ↔ Ennui offerte",
...
Inspirations philosophiques : Nietzsche (chaos créateur), Taoïsme (équilibre), Kandinsky (abstraction vs structure).`,
  ...
  rules: [
    ...
    {
      title: "Originalité",
      description: "100% création originale. Aucun plagiat, aucun AI-généré pur (AI assisté autorisé si retravaillé significativement).",
    },
    {
      title: "Droits",
  ...
  jury: [
    {
      ...
      bio: "Créatrice artwork Amour ↔ Ennui",
    },
    {
      name: "Marc Dubois",
...
export const guestbookPageContent = {
  hero: {
    label: "COMMUNAUTÉ",
    title: "Livre d'Or",
    description: "Votre voix façonne ARTERAL. Partagez votre expérience, votez pour vos artistes favoris et rejoignez une communauté passionnée par l'art et la mode.",
    whyShareTitle: "Pourquoi votre avis compte",
    whyShareText: "Chaque message inspire nos créations futures. Votre feedback influence directement les prochaines collections et aide d'autres amateurs d'art à découvrir ARTERAL. Ensemble, nous construisons plus qu'une marque — une communauté.",
    communityTitle: "Rejoignez la Communauté",
    communitySubtitle: "2 847 visiteurs ont déjà partagé leur expérience",
  },
  stats: {
    visitors: "Visiteurs",
    messages: "Messages",
  ...
  social: {
    callToAction: "Partagez votre découverte d'ARTERAL avec vos amis !",
    shareText: "Je viens de découvrir ARTERAL - L'art rencontre la mode. Une expérience unique !",
  },
  voting: {
    label: "PRIX DU PEUPLE",
    title: "Votez pour votre Œuvre Favorite",
    description: "Soutenez les artistes du concours ARTERAL ! Votre vote compte pour le Prix du Peuple. Les gagnants seront exposés et récompensés.",
    artworkPlaceholder: "Œuvre du concours",
    by: "par",
    votesLabel: "votes",
    voteButton: "Voter",
    voted: "Voté !",
    sharePrompt: "Partagez votre vote sur les réseaux sociaux !",
    shareTwitter: "Partager sur X",
    shareInstagram: "Partager sur Instagram",
  },
  form: {
    title: "Laissez votre Empreinte",
    subtitle: "Votre message rejoindra notre galerie de témoignages et inspirera la communauté ARTERAL.",
    nameLabel: "Votre nom *",
    namePlaceholder: "Sophie M.",
    messageLabel: "Votre message *",
    messagePlaceholder: "Qu'est-ce qui vous a marqué chez ARTERAL ? Partagez votre expérience, vos émotions, vos découvertes...",
    moodLabel: "Comment vous sentez-vous ?",
    submit: "Publier mon message",
    success: "Merci pour votre contribution !",
    successSubtext: "Votre message a été ajouté au Livre d'Or et sera visible par toute la communauté.",
  },
  moods: {
    love: "Amoureux",
    inspired: "Inspiré",
  ...
  entries: {
    ...
    subtitle: "Découvrez ce que les visiteurs d'ARTERAL partagent avec nous",
  },
  cta: {
    title: "Faites Partie de l'Histoire",
    description: "Chaque partage amplifie notre vision. Rejoignez le mouvement ARTERAL sur les réseaux sociaux et restez connecté à notre univers artistique.",
...
export const studioPageContent = {
  ...
  visualiser: {
    ...
    yourArtwork: "Votre œuvre",
    yourMessage: "Votre message",
    finalize: "Finalisez votre soumission",
    finalizeDesc: "Complétez vos informations pour soumettre votre œuvre au concours ARTERAL.",
    artistInfo: "Informations artiste",
    position: {
      label: "Position souhaitée sur le vêtement (optionnel)",
      teamChoice: "Laisser au choix de l'équipe",
      center: "Centre (poitrine)",
      left: "Côté gauche",
      right: "Côté droit",
      back: "Dos",
      full: "Impression complète",
    },
    comment: {
      label: "Commentaire sur l'œuvre (optionnel)",
      placeholder: "Partagez l'histoire derrière votre création, votre inspiration...",
    },
    newsletter: "J'accepte de recevoir des nouvelles concernant mon œuvre et les résultats du concours.",
    submit: "Soumettre mon œuvre",
    ...
    success: {
      ...
      message: "Votre œuvre a été soumise avec succès. Elle sera visible dans le Livret d'Or après validation.",
      confirmSent: "Confirmation envoyée à",
      by: "par",
    },
    validation: {
      fileTooLarge: "Le fichier est trop volumineux. Maximum 10MB.",
      nameRequired: "Veuillez entrer votre nom (min 2 caractères).",
      emailInvalid: "Veuillez entrer une adresse email valide.",
      titleRequired: "Veuillez entrer un titre pour votre œuvre (min 3 caractères).",
      imageRequired: "Veuillez uploader une image.",
      connectionError: "Erreur de connexion. Veuillez réessayer.",
    },
    dragHint: "Glissez l'image pour la repositionner. Utilisez les boutons +/- pour ajuster la taille.",
  },
  navigation: {
    back: "Retour",
    continue: "Continuer",
