...
export const homePageContent = {
  ...
  lookbook: {
    label: "LOOKBOOK",
    title: "Worn by Art",
    quote: "These silhouettes await their soul. Each glitch is an invitation —",
    quoteHighlight: "bring this blank canvas to life",
    quoteSuffix: ", inscribe your art into the fabric of reality.",
    quoteAuthor: "— AWAITING ARTISTS",
    cta: "Discover all models",
  },
  studioGallery: {
    label: "CREATIVE WORKSHOP",
    title: "Art Meets Fashion",
    subtitle: "From philosophers to artists, each reference inspires our creations",
    cta: "Create your artwork",
  },
};
...
export const contestPageContent = {
  ...
  rules: {
    ...
    guide: {
      title: "Resources for your creation",
      downloadTitle: "Download the complete brief",
      downloadDescription: "Everything you need: visual references, philosophical texts, suggested color palette, and inspirations.",
...
export const guestbookPageContent = {
  hero: {
    label: "COMMUNITY",
    title: "Guestbook",
    description: "Your voice shapes ARTERAL. Share your experience, vote for your favorite artists and join a community passionate about art and fashion.",
    whyShareTitle: "Why your opinion matters",
    whyShareText: "Every message inspires our future creations. Your feedback directly influences upcoming collections and helps other art lovers discover ARTERAL. Together, we're building more than a brand — a community.",
    communityTitle: "Join the Community",
    communitySubtitle: "2,847 visitors have already shared their experience",
  },
  stats: {
    visitors: "Visitors",
    messages: "Messages",
  ...
  social: {
    callToAction: "Share your ARTERAL discovery with your friends!",
    shareText: "I just discovered ARTERAL - Where art meets fashion. A unique experience!",
  },
  voting: {
    label: "PEOPLE'S CHOICE",
    title: "Vote for your Favorite Artwork",
    description: "Support the artists of the ARTERAL contest! Your vote counts for the People's Choice Award. Winners will be exhibited and rewarded.",
    artworkPlaceholder: "Contest artwork",
    by: "by",
    votesLabel: "votes",
    voteButton: "Vote",
    voted: "Voted!",
    sharePrompt: "Share your vote on social media!",
    shareTwitter: "Share on X",
    shareInstagram: "Share on Instagram",
  },
  form: {
    title: "Leave your Mark",
    subtitle: "Your message will join our gallery of testimonials and inspire the ARTERAL community.",
    nameLabel: "Your name *",
    namePlaceholder: "Sophie M.",
    messageLabel: "Your message *",
    messagePlaceholder: "What struck you about ARTERAL? Share your experience, emotions, discoveries...",
    moodLabel: "How are you feeling?",
    submit: "Publish my message",
    success: "Thank you for your contribution!",
    successSubtext: "Your message has been added to the Guestbook and will be visible to the entire community.",
  },
  moods: {
    love: "In Love",
    inspired: "Inspired",
  ...
  entries: {
    ...
    subtitle: "Discover what ARTERAL visitors share with us",
  },
  cta: {
    title: "Be Part of the Story",
    description: "Every share amplifies our vision. Join the ARTERAL movement on social media and stay connected to our artistic universe.",
...
export const studioPageContent = {
  ...
  visualiser: {
    ...
    yourArtwork: "Your artwork",
    yourMessage: "Your message",
    finalize: "Finalize your submission",
    finalizeDesc: "Complete your information to submit your artwork to the ARTERAL contest.",
    artistInfo: "Artist Information",
    position: {
      label: "Preferred position on garment (optional)",
      teamChoice: "Leave it to the team",
      center: "Center (chest)",
      left: "Left side",
      right: "Right side",
      back: "Back",
    ...
    comment: {
      label: "Comment about the artwork (optional)",
      placeholder: "Share the story behind your creation, your inspiration...",
    },
    newsletter: "I agree to receive updates about my artwork and contest results.",
    submit: "Submit my artwork",
    submitting: "Sending...",
    terms: "By submitting, you accept that your work may be used as part of the ARTERAL contest.",
    success: {
      title: "Submission Sent!",
      message: "Your artwork has been successfully submitted. It will be visible in the Guestbook after validation.",
      confirmSent: "Confirmation sent to",
      by: "by",
    },
    validation: {
      ...
      titleRequired: "Please enter a title for your artwork (min 3 characters).",
      imageRequired: "Please upload an image.",
      connectionError: "Connection error. Please try again.",
      storyboardMin: "Add at least 4 images for your storyboard.",
      storyboardMax: "Maximum 9 images for the storyboard.",
    },
    storyboard: {
      title: "Creation Storyboard",
      subtitle: "Share your creative process in 4 to 9 images",
      description: "Add images that tell the story of your creation: inspirations, sketches, details, etc.",
      ...
      images: "images",
      minimum: "more image(s) needed",
      complete: "Storyboard complete",
    },
    dragHint: "Drag the image to reposition. Use +/- buttons to adjust size.",
  },
  navigation: {
    back: "Back",
    continue: "Continue",
  ...
  contest: {
    ...
    prizes: {
      label: "REWARDS",
      title: "Crowdfunding Prizes",
      crowdfundingNote: "Prizes depend on the success of our Ulule campaign. The more we raise, the more artists win!",
      tiers: [
        {
          goal: "€5,000",
          goalLabel: "TIER 1",
          prizes: [
            { label: "1st Prize", amount: "€2,000" },
      ...
      rewards: [
        "Your art printed on the collection",
        "Artist credit on each piece",
        "Collection pieces offered",
      ],
      followUs: {
        title: "Stay informed",
        description: "To discover all contest details and follow the campaign progress:",
        instagram: "Follow us on Instagram",
        instagramHandle: "@arteral_clo",
        ulule: "Ulule campaign coming soon",
        ululeNote: "The Ulule page will be launched soon with all reward details.",
      },
    },
    rules: {
      label: "PARTICIPATION",
...
export const connexionPageContent = {
  ...
  form: {
    email: "Email",
    password: "Password",
    passwordHint: "(12 chars min, 1 uppercase, 1 lowercase, 1 special)",
    fullName: "Full name *",
...
{ name: "Manifesto & Process", href: "/manifeste" },
