    ...
    <div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="bg-white p-8 md:p-12 rounded-lg shadow-lg">
              <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-dark mb-4 md:mb-6 text-center">
                {contactContent.newsletter.headline}
              </h2>
              <p className="font-body text-base md:text-lg text-dark/70 mb-8 md:mb-10 text-center">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label
                      htmlFor="email"
                      className="block font-body text-sm font-semibold text-dark mb-2"
                    >
                      Email *
                    </label>
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 md:py-4 font-body text-base border-2 border-dark/20 rounded-lg focus:outline-none focus:border-primary transition-colors"
                  ...
                  <p className="font-body text-xs md:text-sm text-dark/60 text-center mt-4">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-dark mb-8 md:mb-12 text-center">
              Nous contacter
            </h2>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <FadeIn delay={0.1}>
              <a
                ...
                className="bg-gradient-to-br from-primary/5 to-primary/10 p-6 md:p-8 rounded-lg hover:shadow-lg transition-all duration-300 group flex items-center gap-4"
              >
                ...
                <div>
                  <p className="font-body text-sm font-semibold text-dark/60 uppercase tracking-wider mb-1">
                    Email
                  </p>
                  <p className="font-body text-base md:text-lg text-dark font-semibold">
            ...
            <FadeIn delay={0.2}>
              <a
                ...
                className="bg-gradient-to-br from-accent/5 to-accent/10 p-6 md:p-8 rounded-lg hover:shadow-lg transition-all duration-300 group flex items-center gap-4"
              >
              ...
              <FadeIn key={index} delay={index * 0.05}>
                <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-6 md:p-8 text-left hover:bg-light/50 transition-colors"
                  >
                    <h3 className="font-body text-base md:text-lg font-semibold text-dark pr-4">
                      {item.question}
                    </h3>
                    <ChevronDown
