...
export default function MarquePage() {
  return (
    <div>
            ...
            {aboutContent.philosophy.map((item, index) => {
              ...
              return (
                <FadeIn key={item.title} delay={index * 0.2}>
                  <div className="text-center group p-6 md:p-8 rounded-lg hover:bg-white transition-all duration-300 hover:shadow-lg">
      ...
      {/* Values Section */}
      <section className="py-16 md:py-24 bg-gradient-to-br from-dark/5 to-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-center text-dark mb-12 md:mb-16">
              Nos Valeurs
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {aboutContent.values.map((value, index) => (
              <FadeIn key={value.title} delay={index * 0.15}>
                <div className="bg-white p-6 md:p-8 rounded-lg hover:shadow-lg transition-all duration-300 group">
